...
const EachNewsPage = () => {
    return ( <StyledEachNewsPage>
        <section className="each-section">
            ...
            <h1>LATEST DAD!!! Congratulations Pour In As Victony Welcomes Bouncing Baby Girl (PHOTO)</h1>
            <p className="type_date">Posted on 4/12/2023</p>
            <Image src='/img/bg1.png' alt="news img" width={485} height={300} className="cover-img"/>
            <p className="tag">Entertaiment</p>
            <h2>Afrobeats sensation, Victony, is overjoyed as he becomes a father after welcoming a bouncing baby girl with his partner.</h2>
